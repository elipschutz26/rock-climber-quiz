...
export default function ResultPage({ searchParams }: ResultPageProps) {
  ...
  return (
    <main className="relative min-h-screen flex flex-col" style={{ background: `linear-gradient(to bottom, ${theme.topColor} 0%, #070d1a 70%)` }}>

      {/* Photo — full screen, fades out via gradient overlay */}
      ...
      {/* Gradient: transparent at top → type color in middle → dark at bottom */}
      <div
      ...
      {/* Badge — top */}
      <div className="relative z-10 pt-7 flex justify-center animate-fade-in delay-0">
      ...
      {/* Content — always on solid dark area, perfect contrast */}
      <div className="relative z-10 flex flex-col items-center text-center px-6 pb-10 max-w-md mx-auto w-full">
        ...
        <div className="w-full space-y-3 animate-fade-in-up delay-400">
          <Link
            href="/quiz"
